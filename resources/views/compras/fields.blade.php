<div class="card-content collapse show" id="root">
            ...
            methods: {
                ...
                async getItems () {
                    ...
                    try {
                        ...
                        let params= { params: {compra_id: @json($compra->id) } }
