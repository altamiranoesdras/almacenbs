...
class Solicitud extends Model
{
    ...
    public function muestraCantidadAutorizada()
    {
        return $this->fecha_autoriza && $this->fecha_autoriza->isPast();
    }
...
//        return $this->estado_id != SolicitudEstado::ANULADA && $this->estado_id == SolicitudEstado::DESPACHADA;
    ...
    public function generaFolio($folio=null): void
    {

        $envioFiscal = EnvioFiscal::where('nombre_tabla', EnvioFiscal::TABLA_SOLICITUDES)
            ->where('activo', 'si')
            ->first();
        ...
        $this->folio = $folio;
        $this->envio_fiscal_id = $envioFiscal->id;
        $this->save();
