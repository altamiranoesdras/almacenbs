...
@section('title_page',__('Edit User Despacha User'))
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                   ...
                   {!! Form::model($userDespachaUser, ['route' => ['userDespachaUsers.update', $userDespachaUser->id], 'method' => 'patch','class' => 'wait-on-submit']) !!}
                        <div class="form-row">
