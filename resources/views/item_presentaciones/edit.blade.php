...
@section('titulo_pagina',__('Edit Item Presentacion'))
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                   ...
                   {!! Form::model($itemPresentacion, ['route' => ['itemPresentaciones.update', $itemPresentacion->id], 'method' => 'patch','class' => 'esperar']) !!}
                        <div class="row">
