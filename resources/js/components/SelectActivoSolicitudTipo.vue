...
<script>
export default {
    name: 'select-activo-solicitud-tipo',
    created() {
    ...
    props:{
        ...
        name: {
            type: String,
            default: 'activo_solicitud_tipo_id'
        },
        label:{
            type: String,
            required: true,
        ...
        id:{
            type: String,
            default: 'modal_select_activo_solicitud_tipo'
        },
        disabled:{
            type: Boolean,
            default: false
    ...
    methods: {
        ...
        async getItems () {
            ...
            try {
                ...
                var res = await axios.get(route('api.activo_solicitud_tipos.index'));
        ...
        async save () {
            ...
            try {
                ...
                if(this.editedItem.id === 0){
                    ...
                    var res = await axios.post(route('api.activo_solicitud_tipos.store'),data);

                }else {

                    var res = await axios.patch(route('api.activo_solicitud_tipos.update',this.editedItem.id),data);
