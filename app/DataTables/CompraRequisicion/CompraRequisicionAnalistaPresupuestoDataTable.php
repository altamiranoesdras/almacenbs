...
class CompraRequisicionAnalistaPresupuestoDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        return $dataTable
            ->addColumn('action', function (CompraRequisicion $requisicion) {
                $id = $requisicion->id;
                return view('compra_requisiciones.analista_presupuesto.datatables_actions',
            ...
            ->editColumn('codigo',function (CompraRequisicion $requisicion){
                return view('compra_requisiciones.analista_presupuesto.modal_show_requisicion',compact('requisicion'))->render();
            })
