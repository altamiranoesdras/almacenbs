...
export default {
    name: "dual-listbox-compra-requisicion-estados",
    mounted() {
        $(function (){
        ...
        async save () {
            ...
            try {
                ...
                if(this.editedItem.id === 0){
                    ...
                    var res = await axios.post(route('api.compra.requisiciones.estados.store'),data);

                }else {

                    var res = await axios.patch(route('api.compra.requisiciones.estados.update',this.editedItem.id),data);
