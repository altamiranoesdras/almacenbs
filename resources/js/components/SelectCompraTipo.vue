...
export default {
    ...
    props:{
        ...
        id:{
            type: String,
            default: 'modal_select_compra_tipo'
        },
        disabled:{
            type: Boolean,
            default: false
    ...
    methods: {
        ...
        async getItems () {
            ...
            try {
                ...
                var res = await axios.get(route('api.compra_tipos.index'));
        ...
        async save () {
            ...
            try {
                ...
                if(this.editedItem.id === 0){
                    ...
                    var res = await axios.post(route('api.compra_tipos.store'),data);

                }else {

                    var res = await axios.patch(route('api.compra_tipos.update',this.editedItem.id),data);
