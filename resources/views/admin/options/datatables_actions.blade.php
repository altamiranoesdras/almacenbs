@can('Ver opcion menu')
<a href="{{ route('dev.option.create', $id) }}" data-toggle="tooltip" title="Nueva" class='btn btn-outline-success btn-xs'>
...
<a href="{{ route('dev.options.edit', $id) }}" data-toggle="tooltip" title="Editar" class='btn btn-outline-info btn-xs'>
