    ...
    methods: {
        ...
        async getItems () {
            ...
            try {
                ...
                var res = await axios.get(route('api.marcas.index'));
        ...
        async save () {
            ...
            try {
                ...
                if(this.editedItem.id === 0){
                    ...
                    var res = await axios.post(route('api.marcas.store'),data);

                }else {

                    var res = await axios.patch(route('api.marcas.update',this.editedItem.id),data);
