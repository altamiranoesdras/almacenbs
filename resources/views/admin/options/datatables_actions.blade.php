@can('Ver opcion menu')
<a href="{{ route('option.create', $id) }}" data-toggle="tooltip" title="Nueva" class='btn btn-icon btn-flat-success rounded-circle'>
...
<a href="{{ route('options.edit', $id) }}" data-toggle="tooltip" title="Editar" class='btn btn-icon btn-flat-info rounded-circle'>
