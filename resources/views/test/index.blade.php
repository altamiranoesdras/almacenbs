                    ...
                    <div class="card-body pt-1">
                        <form method="POST" action="{{ route('firmar.documento') }}" enctype="multipart/form-data" class="esperar row g-3">
                            ...
                            <div class="col-md-7">
                                ...
                                {{-- Rúbrica --}}
                                <div class="mb-2">
                                    <label class="form-label">Rúbrica</label><br>
                                    ...
                                    <div class="row g-2">
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" type="number" name="firma_inicio_x" id="firma_inicio_x" required value="250">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" type="number" name="firma_inicio_y" id="firma_inicio_y" required value="15">
                                                <span class="input-group-text">mm</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" type="number" name="firma_ancho" id="firma_ancho" required value="250">
                                                <span class="input-group-text">mm</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" type="number" name="firma_alto" id="firma_alto" required value="65">
                                                <span class="input-group-text">mm</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
