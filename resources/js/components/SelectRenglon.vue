                        ...
                        <div class="modal-body">
                            <div class="form-row">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" class="form-control" @keydown.enter.prevent="save()" v-model="editedItem.numero" >
                                </div>

                                <!-- Nombre Field -->
                                <div class="form-group col-sm-6">
                                    <label for="descripcion">Nombre:</label>
                                    <input type="text" class="form-control" @keydown.enter.prevent="save()" v-model="editedItem.descripcion" >
                                </div>
    ...
    methods: {
        ...
        async getItems () {
            ...
            try {
                ...
                var res = await axios.get(route('api.renglones.index'));
        ...
        async save () {
            ...
            try {
                ...
                if(this.editedItem.id === 0){
                    ...
                    var res = await axios.post(route('api.renglones.store'),data);

                }else {

                    var res = await axios.patch(route('api.renglones.update',this.editedItem.id),data);
