<template>
    <div>
        ...
        <input type="hidden" name="roles[]" :value="rol.id" v-for="rol in destination">
        ...
        async save () {
            ...
            try {
                ...
                if(this.editedItem.id === 0){
                    ...
                    var res = await axios.post(route('api.roles.store'),data);

                }else {

                    var res = await axios.patch(route('api.roles.update',this.editedItem.id),data);
