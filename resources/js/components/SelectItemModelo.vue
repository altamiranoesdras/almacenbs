...
export default {
    ...
    props:{
        ...
        id:{
            type: String,
            default: 'modal_select_item_modelo'
        },
        disabled:{
            type: Boolean,
            default: false
    ...
    methods: {
        ...
        async getItems () {
            ...
            try {
                ...
                var res = await axios.get(route('api.item_modelos.index'));
        ...
        async save () {
            ...
            try {
                ...
                if(this.editedItem.id === 0){
                    ...
                    var res = await axios.post(route('api.item_modelos.store'),data);

                }else {

                    var res = await axios.patch(route('api.item_modelos.update',this.editedItem.id),data);
