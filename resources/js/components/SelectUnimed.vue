        ...
        async save () {
            ...
            try {
                ...
                if(this.editedItem.id === 0){
                    ...
                    var res = await axios.post(route('api.unimeds.store'),data);

                }else {

                    var res = await axios.patch(route('api.unimeds.update',this.editedItem.id),data);
