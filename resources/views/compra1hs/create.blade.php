...
@section('titulo_pagina',__('New Compra1H'))
...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    {!! Form::open(['route' => 'compra1hs.store','class' => 'esperar']) !!}
                        <div class="row">
                            ...
                            <div class="col-sm-12 mb-1 text-right">
                                <a href="{!! route('compra1hs.index') !!}" class="btn btn-outline-secondary round me-1">
                                    Cancelar
                                </a>
                                &nbsp;
