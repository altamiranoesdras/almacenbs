...
class SolicitudeDespachaDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', function ($solicitud){
                ...
                return view('solicitudes.datatables_actions_despachar',compact('solicitud','id'))->render();
            })
            ...
            ->editColumn('codigo',function ($solicitud){
                $despachar=1;
                return view('solicitudes.modal_show',compact('solicitud','despachar'))->render();
            })
    ...
    public function query(Solicitud $model)
    {
        ...
        return $model->newQuery()->with(['userSolicita','userDespacha','estado','detalles.item'])
            ->whereIn('user_solicita',$user->usersDespacha->pluck('id')->toArray())
            ->where('estado_id',SolicitudEstado::SOLICITADA);
    }
