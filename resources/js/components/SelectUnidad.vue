...
export default {
    ...
    props:{
        ...
        id:{
            type: String,
            default: 'modal_select_rrhh_unidad'
        },
        disabled:{
            type: Boolean,
            default: false
    ...
    methods: {
        ...
        async getItems () {
            ...
            try {
                ...
                var res = await axios.get(route('api.rrhh_unidades.index'));
        ...
        async save () {
            ...
            try {
                ...
                if(this.editedItem.id === 0){
                    ...
                    var res = await axios.post(route('api.rrhh_unidades.store'),data);

                }else {

                    var res = await axios.patch(route('api.rrhh_unidades.update',this.editedItem.id),data);
