...
export default {
    ...
    props:{
        ...
        id:{
            type: String,
            default: 'modal_select_rrhh_puesto'
        },
        disabled:{
            type: Boolean,
            default: false
    ...
    methods: {
        ...
        async getItems () {
            ...
            try {
                ...
                var res = await axios.get(route('api.rrhh_puestos.index'));
        ...
        async save () {
            ...
            try {
                ...
                if(this.editedItem.id === 0){
                    ...
                    var res = await axios.post(route('api.rrhh_puestos.store'),data);

                }else {

                    var res = await axios.patch(route('api.rrhh_puestos.update',this.editedItem.id),data);
