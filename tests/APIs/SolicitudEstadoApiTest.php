...
class SolicitudEstadoApiTest extends TestCase
{
    ...
    {
        $solicitudEstado = SolicitudEstado::factory()->make()->toArray();
    ...
    {
        $solicitudEstado = SolicitudEstado::factory()->create();
    ...
    {
        $solicitudEstado = SolicitudEstado::factory()->create();
        $editedSolicitudEstado = SolicitudEstado::factory()->make()->toArray();
