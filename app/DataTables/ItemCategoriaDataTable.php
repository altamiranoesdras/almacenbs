...
class ItemCategoriaDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ->eloquent($query)
            ->addColumn('action', function(ItemCategoria $itemCategoria){

                 $id = $itemCategoria->id;

                 return view('item_categorias.datatables_actions',compact('itemCategoria','id'))->render();
             })
             ->editColumn('id',function (ItemCategoria $itemCategoria){

                 return $itemCategoria->id;
     ...
     *
     * @param \App\Models\ItemCategoria $model
