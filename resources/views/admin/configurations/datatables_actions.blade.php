...
<a href="{{ route('dev.configurations.show', $id) }}" data-bs-toggle="tooltip" title="Ver" class='btn btn-outline-secondary btn-sm'>
    <i class="fa fa-eye"></i>
</a>
@endcan

@can('Editar configuración')
<a href="{{ route('dev.configurations.edit', $id) }}" data-bs-toggle="tooltip" title="Editar" class='btn btn-icon btn-outline-info rounded-circle'>
