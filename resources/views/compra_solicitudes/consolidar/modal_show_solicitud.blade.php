            ...
            <div class="modal-body text-uppercase">
                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="mb-2">
                                    ...
                                    <div><strong>{{ $solicitud->codigo }}</strong></div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="mb-2">
                                    ...
                                    <div><strong>{{ $solicitud->unidad->nombre ?? '' }}</strong></div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="mb-2">
                                    <label for="fecha_solicita">Fecha solicita:</label>
                                    <div><strong>{{ fechaLtn($solicitud->fecha_solicita) }}</strong></div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="mb-2">
                                    ...
                                    <span
                                        class="badge bg-{{ $solicitud->estado->color }}">{{ $solicitud->estado->nombre }}</span>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="mb-2">
                                    ...
                                    <div><strong>{{ $solicitud->usuarioSolicita->name ?? '' }}</strong></div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <div><strong>{{ $solicitud->justificacion }}</strong></div>
                    </div>
                </div>
                ...
                <table class="table table-bordered table-hover table-xtra-condensed">
                    ...
                    <tr>
                        ...
                        <th colspan="5" class="text-right">
                            {{$solicitud->detalles->sum('cantidad')}}
                        </th>
                    </tr>
                    </tfoot>
                </table>
