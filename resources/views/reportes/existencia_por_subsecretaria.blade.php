...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    <h1 class="m-0 text-dark">EXISTENCIA POR SUBSECRETARÍA</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            {!! Form::open(['route' => 'reportes.existencia.subsecretaria', 'method' => 'get']) !!}
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <table class="table table-bordered table-striped" id="reportTable">
                                    ...
                                    <tbody>
                                        @foreach($items as $item)
                                            @php
                                                $subsecretarias = $item->solicitudDetalles->pluck('solicitud.unidad.parent.nombre')->unique();
