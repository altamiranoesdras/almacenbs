            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <!-- Botón de cierre actualizado para BS5 -->
...
export default {
    ...
    props:{
        ...
        id:{
            type: String,
            default: 'modal_select_item_presentacion'
        },
        disabled:{
            type: Boolean,
            default: false
    ...
    methods: {
        ...
        async getItems () {
            ...
            try {
                ...
                var res = await axios.get(route('api.item_presentaciones.index'));
        ...
        async save () {
            ...
            try {
                ...
                if(this.editedItem.id === 0){
                    ...
                    var res = await axios.post(route('api.item_presentaciones.store'),data);

                }else {

                    var res = await axios.patch(route('api.item_presentaciones.update',this.editedItem.id),data);
