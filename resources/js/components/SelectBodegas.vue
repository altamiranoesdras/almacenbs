    ...
    methods: {
        ...
        async getItems () {
            ...
            try {
                ...
                var res = await axios.get(route('api.bodegas.index'));
        ...
        async save () {
            ...
            try {
                ...
                if(this.editedItem.id === 0){
                    ...
                    var res = await axios.post(route('api.bodegas.store'),data);

                }else {

                    var res = await axios.patch(route('api.bodegas.update',this.editedItem.id),data);
