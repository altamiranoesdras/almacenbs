...
@section('titulo_pagina','EXISTENCIA POR UNIDAD SOLICITANTE')




@section('content')
    <x-content-header titulo="EXISTENCIA POR UNIDAD SOLICITANTE">
...
<script>
    ...
    new Vue({
            ...
            data: {
                ...
                rr_hh_unidades: @json(\App\Models\RrhhUnidad::areas()->solicitan()->conStock()->get() ?? []),
