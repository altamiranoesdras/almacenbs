@can('Ver Compra Requisicion Proceso Tipos')
    <a href="{{ route('compra.requisiciones.proceso-tipos.show', $id) }}" data-bs-toggle="tooltip" title="Ver" class='btn btn-icon btn-flat-secondary rounded-circle'>
        <i class="fa fa-eye"></i>
    </a>
@endcan

@can('Editar Compra Requisicion Proceso Tipos')
    <a href="{{ route('compra.requisiciones.proceso-tipos.edit', $id) }}" data-bs-toggle="tooltip" title="Editar" class='btn btn-icon btn-flat-info rounded-circle'>
